//==============================================================================
// Tutorial.ipf - N.Leclercq - SOLEIL - 02/2009
//==============================================================================
// IMPORTANT NOTE: 
// On "some" systems - it depends on both the plateform and the Igor's version -
// one might encounter a "font issue". Igor complains because a font used in the
// binding <ipf> files is missing. Just choose a "substitute" when Igor invite
// you to do so. Once fixed, the problem should not raise anymore. 
//==============================================================================
//
...
//
// Most users should first use the functions generated by the "embedded code 
// generator" to access Tango devices. The latter provides a way to generate 
// the Igor Pro interface of a "specific device" or the one of a "device family" 
// The general rule is to generate a "device interface" for devices having a 
// single instance running into the control system (e.g. monochromator device). 
// Choose "class interface" for devices for which several instances exist (e.g. 
// motor devices). In the atter case, you will have to specify the device name 
// you want to communicate with as first function paramater.  
//        
...
//
// 2. Enable the Tango poor man's "expert or super user" option by setting 
//    the variable root:tango:common:xptm to 1 (i.e. true)
//
...
//    Interface". Note that the "target device" must be up and running.
//
// 5. In the popup panel, enter the procedure file name (without .ipf extension), 
//    the functions prefix (recommended to avoid naming conflicts - choose something
//    short here - see [1]) . No need to change the target device name (just leave 
//    it as it is).
//
...
// --------------------------
//	[1] : use short functions "prefix": Igor doesn't like long function names at all.
//		  on some devices with very long attribute names, you could face the problem.
//        no choice in the case, adapt the generated code till it compiles then save 
//        your modification (i.e. change the problematic function names).
//
//==============================================================================
//
// There are some contexts in which the low level approach is required 
// and even mandatory. This is typically the case when you need to read or
// write several attributes on the ***same device*** in a single call. See 
// Chapter II  "Reading one (or more) attribute(s) on a TANGO device" of the 
// present tutorial to learn how to do so.
//   
//==============================================================================
// 
...
// test_tango_cmd_io("sys/tg_test/1")]. You can also test everything by using
// the "tango_test_all"
//
//  Table of Content :
//  ------------------
...
//
// This doc certainly contains some errors and the binding has some hidden 
// bugs so... please let me know.
//
// Happy reading!
//

  ...
  try 
  {
    ...
    switch (argin_type) 
    {
      ...
      case Tango::DEV_BOOLEAN: 
      {
        ...
        Tango::DevBoolean b = d ? true : false;
        dd_in_ << b;
      } break;
      //-------------------------------------------------
  ...
  try 
  {
    ...
    switch (argout_type) 
    {
      ...
      case Tango::DEV_BOOLEAN: 
      {
        Tango::DevBoolean b;
        dd_out_ >> b;
        yat::int32 l = static_cast<yat::int32>(b);
      ...
      case Tango::DEV_USHORT: 
      {
        Tango::DevUShort us;
        dd_out_ >> us;
        yat::int32 l = static_cast<yat::int32>(us);
        if (XDK_UTILS->set_df_obj(dfh, obj_name, l) != kNoError) 
        {
          std::string d = "failed to set global variable <" + _argout + ">";
          d += " (object name or type conflict)";
      ...
      case Tango::DEV_SHORT: 
      {
        Tango::DevShort s;
        dd_out_ >> s;
        yat::int32 l = static_cast<yat::int32>(s);
        if (XDK_UTILS->set_df_obj(dfh, obj_name, l) != kNoError) 
        {
          std::string d = "failed to set global variable <" + _argout + ">";
          d += " (object name or type conflict)";
      ...
      case Tango::DEV_ULONG: 
      {
        Tango::DevULong ul;
        dd_out_ >> ul;
        yat::int32 l = static_cast<yat::int32>(ul);
        if (XDK_UTILS->set_df_obj(dfh, obj_name, l) != kNoError) 
        {
          std::string d = "failed to set global variable <" + _argout + ">";
          d += " (object name or type conflict)";
      ...
      case Tango::DEV_STATE: 
      {
        Tango::DevState ds;
        dd_out_ >> ds;
        if (XDK_UTILS->set_df_obj(dfh, obj_name, static_cast<yat::int32>(ds))) 
        {
          std::string d = "failed to set global variable <" + _argout + ">";
          d += " (object name or type conflict)";
          XDK_UTILS->set_error("invalid argout specified",
        ...
        switch (attr_type) 
        {
          ...
          case Tango::DEV_ULONG: 
          {
            ...
            if (XDK_UTILS->get_df_obj (dfh, obj_name, &d)) 
            {
              ...
              l = *(reinterpret_cast<yat::int32*>(static_cast<char*>(*wave) + offset));
            }
            else 
            {
      ...
      case Tango::IMAGE: 
      {
        ...
        switch (attr_format)
        {
          case Tango::SPECTRUM:
            ...
            value_.dim_x = static_cast<int>(w_dims[0]);
            value_.dim_y = 0;
            break;
          case Tango::IMAGE:
            this->insert(value_, wave, w_dims[0], w_dims[1]); 
            value_.dim_x =  static_cast<int>(w_dims[0]);
            value_.dim_y =  static_cast<int>(w_dims[1]);
            break;
        }
      } break; 
      //-------------------------------------------------
      ...
      case Tango::SCALAR: 
      {
        ...
        switch (attr_type) 
        {
          ...
          case Tango::DEV_STATE: 
          {
            Tango::DevState s;
            value_ >> s;
            err = XDK_UTILS->set_df_obj(dfh, obj_name, static_cast<yat::int32>(s));  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name or type conflict)";
          ...
          case Tango::DEV_BOOLEAN: 
          {
            Tango::DevBoolean b;
            value_ >> b;
            err = XDK_UTILS->set_df_obj(dfh, obj_name, static_cast<yat::int32>(b ? 1 : 0));  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name or type conflict)";
          ...
          case Tango::DEV_UCHAR: 
          {
            Tango::DevUChar uc;
            value_ >> uc;
            err = XDK_UTILS->set_df_obj(dfh, obj_name, static_cast<yat::int32>(uc));  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name or type conflict)";
          ...
          case Tango::DEV_USHORT: 
          {
            Tango::DevUShort us;
            value_ >> us;
            err = XDK_UTILS->set_df_obj(dfh, obj_name, static_cast<yat::int32>(us));  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name or type conflict)";
          ...
          case Tango::DEV_ULONG: 
          {
            Tango::DevULong ul;
            value_ >> ul;
            err = XDK_UTILS->set_df_obj(dfh, obj_name, static_cast<yat::int32>(ul));  
            if (err) 
            {
              std::string d = "failed to set global variable <" + _argout + ">";
              d += " (object name or type conflict)";
...
public:
  static int num_wave(waveHndl _wh, Tango::DeviceData& dd_)
  {
    ...
    if (array == 0)
      return kError;
    array->length(static_cast<CORBA::ULong>(np));
    BCInt offset;
  ...
  static int num_wave(waveHndl _wh, Tango::DeviceAttribute& da_)
  {
    ...
    if (::MDGetWaveDimensions(_wh, &ndims, dim_size))
      return kError;
    CountInt np = dim_size[0];
	  da_.dim_x = static_cast<int>(dim_size[0]);
	  da_.dim_y = 0;
    switch (ndims) 
    {
      case 1:
      ...
      case 2:
        np *= dim_size[1];
        da_.dim_y = static_cast<int>(dim_size[1]);
        break;
      default:
        return kError;
        break;
...
void DataCodec::insert (Tango::DeviceData& _dd, const waveHndl _wh)
{
  switch (::WaveType(_wh)) 
  {
    ...
    {
      if (Insert<Tango::DevVarUCharArray, Tango::DevUChar>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16: 
    {
      if (Insert<Tango::DevVarShortArray, Tango::DevShort>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    {
      if (Insert<Tango::DevVarUShortArray, Tango::DevUShort>::num_wave(_wh, _dd))  
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32: 
    {
      if (Insert<Tango::DevVarLongArray, Tango::DevLong>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    {
      if (Insert<Tango::DevVarULongArray, Tango::DevULong>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP32: 
    {
      if (Insert<Tango::DevVarFloatArray, Tango::DevFloat>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP64: 
    {
      if (Insert<Tango::DevVarDoubleArray, Tango::DevDouble>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
...
void DataCodec::insert (Tango::DeviceData& _dd, const waveHndl _wn, const waveHndl _ws) 
{
  ...
  CountInt wn_np = ::WavePoints(_wn);
  CountInt ws_np = ::WavePoints(_ws);
  //- Insert wave<yat::int32 | double>
  BCInt offset;
  ...
  switch (wn_type)
  {
    ...
    case NT_I32:
    {
      ...
      ls_array->lvalue.length(static_cast<CORBA::ULong>(wn_np));
      char *base_addr = static_cast<char*>(*_wn) + offset;
      ::memcpy(ls_array->lvalue.get_buffer(), base_addr, wn_np * sizeof(Tango::DevLong));
    ...
    case NT_FP64:
    {
      ...
      ds_array->dvalue.length(static_cast<CORBA::ULong>(wn_np));
      char *base_addr = static_cast<char*>(*_wn) + offset; 
      ::memcpy(ds_array->dvalue.get_buffer(), base_addr, wn_np * sizeof(Tango::DevDouble));
...
// DataCodec::insert 
// ============================================================================
void DataCodec::insert (Tango::DeviceAttribute& _da, waveHndl _wh, CountInt _dim_x, CountInt _dim_y)
{
  switch (::WaveType(_wh)) 
  {
    //-------------------------------------------------
    ...
    case NT_I8|NT_UNSIGNED: 
    {
      if (Insert<Tango::DevVarCharArray, Tango::DevUChar>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16: 
    {
      if (Insert<Tango::DevVarShortArray, Tango::DevShort>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16|NT_UNSIGNED: 
    {
      if (Insert<Tango::DevVarUShortArray,Tango::DevUShort>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32: 
    {
      if (Insert<Tango::DevVarLongArray, Tango::DevLong>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32|NT_UNSIGNED:  
    {
      if (Insert<Tango::DevVarULongArray, Tango::DevULong>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP32: 
    {
      if (Insert<Tango::DevVarFloatArray, Tango::DevFloat>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP64: 
    {
      if (Insert<Tango::DevVarDoubleArray, Tango::DevDouble>::num_wave(_wh, _da)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case TEXT_WAVE_TYPE: 
    {
      ...
      char *tmp = 0;
      int  max_j = (ndims > 1) ? static_cast<int>(dim_size[1]) : 1;
...
public: 
  ...
  static int num_wave (const A *_seq, waveHndl _wh, CountInt dim_x, CountInt dim_y = 0)
  {
    int w_ndims = 0;
    MDWaveDims w_dims;
    ::MemClear(w_dims, sizeof(MDWaveDims));
    ...
    if (::MDGetWaveDimensions(_wh, &w_ndims, w_dims))
      return kError;
    CountInt actual_ndims = dim_y ? 2 : 1;
    switch (actual_ndims)
    {
      case 1:
    ...
    CountInt size_to_copy = dim_x * (dim_y ? dim_y : 1);
  ...
  static int txt_wave (const A* _seq, waveHndl _wh, CountInt dim_x, CountInt dim_y = 0)
  {
    int w_ndims = 0;
    MDWaveDims w_dims;
    ::MemClear(w_dims, sizeof(MDWaveDims));
    ...
    for (int j = 0; j < dim_y; j++) 
    {
      for (int i = 0; i < dim_x; i++) 
      {
        ...
        ::memcpy(*txt_hndl, 
                 (*_seq)[static_cast<CORBA::ULong>(i + j * dim_y)], 
                 ::strlen((*_seq)[static_cast<CORBA::ULong>(i + j * dim_y)]) * sizeof(T));
...
void DataCodec::extract (const Tango::DeviceData& _const_dd, waveHndl _wh)
{
  ...
  switch (::WaveType(_wh)) 
  {
    ...
    case NT_I8|NT_UNSIGNED: 
    {
      if (Extract<Tango::DevVarCharArray, Tango::DevUChar>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16:
    {
      if (Extract<Tango::DevVarShortArray, Tango::DevShort>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16|NT_UNSIGNED:
    {
      if (Extract<Tango::DevVarUShortArray, Tango::DevUShort>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32:
    {
      if (Extract<Tango::DevVarLongArray, Tango::DevLong>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32|NT_UNSIGNED:
    {
      if (Extract<Tango::DevVarULongArray, Tango::DevULong>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP32:
    {
      if (Extract<Tango::DevVarFloatArray, Tango::DevFloat>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP64:
    {
      if (Extract<Tango::DevVarDoubleArray, Tango::DevDouble>::num_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case TEXT_WAVE_TYPE:
    {
      if (Extract<Tango::DevVarStringArray, Tango::DevUChar>::txt_wave(_wh, _dd)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
...
void DataCodec::extract (const Tango::DeviceData& _const_dd, waveHndl _wn, waveHndl _ws) 
{
  ...
  switch (::WaveType(_wn))
  {
    ...
    case NT_I32:
    {
      ...
      if (Extract<Tango::DevVarLongArray, yat::int32>::num_wave(l_value, _wn, l_value->length())) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wn, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP64:
    {
      ...
      if (Extract<Tango::DevVarDoubleArray, Tango::DevDouble>::num_wave(d_value, _wn, d_value->length())) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wn, wname);
        TangoSys_OMemStream reason;
...
// DataCodec::extract
// ============================================================================
void DataCodec::extract (const Tango::DeviceAttribute& _const_da, waveHndl _wh, CountInt _dim_x, CountInt _dim_y)
{
  ...
  switch (::WaveType(_wh)) 
  {
    ...
    case NT_I8:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarBooleanArray, Tango::DevBoolean>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
      ...
      _da.insert(tango_array, static_cast<int>(_dim_x), static_cast<int>(_dim_y));
      _da.quality = qlt;
#else
      delete tango_array;
#endif
    ...
    case NT_I8|NT_UNSIGNED:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarCharArray, Tango::DevUChar>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16|NT_UNSIGNED:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarUShortArray,Tango::DevUShort>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I16:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarShortArray, Tango::DevShort>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarLongArray, Tango::DevLong>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_I32|NT_UNSIGNED:
    {
      Tango::DevVarULongArray *tango_array = 0;
      _da >> tango_array;
      if (Extract<Tango::DevVarULongArray, Tango::DevULong>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP32:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarFloatArray, Tango::DevFloat>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;
    ...
    case NT_FP64:
    {
      ...
      _da >> tango_array;
      if (Extract<Tango::DevVarDoubleArray, Tango::DevDouble>::num_wave(tango_array, _wh, _dim_x, _dim_y)) 
      {
        char wname[MAX_OBJ_NAME + 1];
        ::WaveName(_wh, wname);
        TangoSys_OMemStream reason;

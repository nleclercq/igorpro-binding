...
private:
  ...
  void insert (Tango::DeviceAttribute& da, waveHndl _wh, CountInt _dim_x, CountInt _dim_y = 0);

  //- extract methods
  void extract (const Tango::DeviceData&, waveHndl wh);
	void extract (const Tango::DeviceData&, waveHndl d_value, waveHndl s_value);
  void extract (const Tango::DeviceAttribute& da, waveHndl wh, CountInt dim_x, CountInt dim_y = 0);

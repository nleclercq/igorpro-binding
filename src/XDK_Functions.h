...
{
public:
    static XOPIORecResult call_mode (XOPIORecParam _xfunc_id);
    // Select exec mode for <_xfunc_id>.
    
    static int exec (XOPIORecParam _xfunc_id, void * _xfunc_params);
...
private:
    ...
    static int tango_reload_device_interface (void *_p);
    //- Tango::DeviceProxy ------------------------------------- 

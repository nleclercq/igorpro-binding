...
:: ======== PATH
SET PATH=%RUNTIME_LIB_X64%;%PATH%

:: ======== OMNIORB
SET OMNIORB_ROOT=%RUNTIME_PATH_X64%
SET OMNIORB_INC=%RUNTIME_INC_X64%
SET OMNIORB_LIB=%RUNTIME_LIB_X64%
...
:: ======== LOG4TANGO
SET LOG4TANGO_ROOT=%RUNTIME_PATH_X64%
SET LOG4TANGO_INC=%RUNTIME_INC_X64%
SET LOG4TANGO_LIB=%RUNTIME_LIB_X64%
SET LOG4TANGO_LIB_LIST=log4tango.lib
SET LOG4TANGO_LIB_DEBUG_LIST=log4tangod.lib

:: ======== TANGO
SET TANGO_ROOT=%RUNTIME_PATH_X64%
SET TANGO_INC=%RUNTIME_INC_X64%
SET TANGO_LIB=%RUNTIME_LIB_X64%
SET TANGO_LIB_LIST=tango.lib
SET TANGO_LIB_DEBUG_LIST=tangod.lib

:: ======== YAT PATHS
set YAT_ROOT=%RUNTIME_PATH_X64%
set YAT_INC=%RUNTIME_INC_X64%
set YAT_LIB=%RUNTIME_LIB_X64%
set YAT_LIB_LIST=yat.lib
set YAT_LIB_DEBUG_LIST=yatd.lib

:: ======== YAT FOR TANGO PATHS
set YAT_FOR_TANGO_ROOT=%RUNTIME_PATH_X64%
set YAT_FOR_TANGO_INC=%RUNTIME_INC_X64%
set YAT_FOR_TANGO_LIB=%RUNTIME_LIB_X64%
